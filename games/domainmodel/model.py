...
class Thread:
    def __init__(self, thread_title: str, thread_content: str):
        ...
        self.tags: list = []
        self.reviews: list = []
        self.user: Optional[User] = None  # New attribute to store the user who created the thread
...
class User:
    def __init__(self, username: str, password: str, email: Optional[str] = None, dob: Optional[str] = None,
                 gender: Optional[str] = None):
        print(
            f"Initializing User with: username={username}, password={password}, email={email}, dob={dob}, gender={gender}")
        ...
        self.favorite = None  # This will be set by SQLAlchemy

        print(f"User initialized: {self.username}, {self.password}, {self.email}, {self.dob}, {self.gender}")
    ...
    def __repr__(self):
        return f"<User {self.username}, {self.password}, {self.email}, {self.dob}, {self.gender}>"
